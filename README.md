...
``` 
        ...
        TriggerEvent('lds_ui:drawtextuiwithinput',table)
...
``` 
        ...
        TriggerEvent('lds_ui:showui',table)`
                ...
                local coords = GetEntityCoords(PlayerPedId())
                    for i, v in pairs(Config.Locations) do
                        ...
                        if dist <= 3.5 then
                           ...
                           TriggerEvent('lds_ui:drawtextuiwithinput',table) -- show the ui
                           ...
                           TriggerEvent('lds_ui:closeui') -- close the ui once dist is > 3.5
                ...
                local coords = GetEntityCoords(PlayerPedId())
                    for i, v in pairs(Config.Locations) do
                        ...
                        if dist <= 3.5 then
                           ...
                           TriggerEvent('lds_ui:showui',table) -- show the ui
                           while dist <= 3.5 do -- wait for dist become > 3.5 and close the ui once its > 3.5
                                coords = GetEntityCoords(PlayerPedId() -- coords need to be here to be refreshed ea 500ms
                                dist = GetDistanceBetweenCoords(pos["x"], pos["y"], pos["z"] + 0.98, coords, true)
                                Wait(500)
